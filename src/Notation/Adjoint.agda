...
module _ {ℓ-ob : ℓ-ob-sig} {Ob : ob-sig ℓ-ob}
  {ℓ-hom : ℓ-hom-sig} (C : Quiver-on Ob ℓ-hom) (open Quiver-on C) (C₂ : 2-Quiver-on C) (open 2-Quiver-on C₂) (C₃ : 3-Quiver-on C C₂) (open 3-Quiver-on C₃)
  ...
  record Adjoint (L : Hom c d) (R : Hom d c) : Type (ℓ-hom ℓc ℓc l⊔ ℓ-hom ℓd ℓd l⊔ ℓ-hom ℓc ℓd l⊔ ℓ-hom ℓd ℓc) where
    ...
    field
      η   : 2-Hom refl (L ∙ R)
      ε   : 2-Hom (R ∙ L) refl
      zig : 3-Hom (id-i L ∙ (η ▷ L) ∙ assoc L R L ∙ (L ◁ ε) ∙ id-o L) refl
      zag : 3-Hom (id-o R ∙ (R ◁ η) ∙ assoc R L R ∙ (ε ▷ R) ∙ id-i R) refl
